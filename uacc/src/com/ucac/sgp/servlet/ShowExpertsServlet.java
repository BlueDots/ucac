	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       if(request.getParameter("requestType")==null ){
    	   ...
    	   try {
    	      ...
    	      try {
    	    	  ...
    	    	  filterPassword(experts);
    		          ...
    		          request.getRequestDispatcher("./manager/admin_error.jsp").forward(request, response);
    		          return ;
    	          } catch (DBException e) {
    	        	  request.setAttribute("errorMesg",e.getMessage());
    		          request.getRequestDispatcher("./manager/admin_error.jsp").forward(request, response);
    	      ...
    	      if(requestUrl==null){
    	    	  ...
    	    	  request.getRequestDispatcher("./manager/admin_ExpertInfo.jsp").forward(request, response);
    	      }
    	  ...
    	  // response.setContentType("text/xml;charset=utf-8");
    	   ...
    	   if(experts!=null){
     		    //System.out.println(experts.getResults().size());
    		   	page.setCount((int)experts.getTotalCount());
    		   ...
    		   buffer.append(",").append(gson.toJson(page));
				...
				buffer.append(gson.toJson(linkNum));
				buffer.append("}");
    		   buffer.append("]");
