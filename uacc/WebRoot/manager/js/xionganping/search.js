...
$(document).ready(
		function() {
		 // 获得输入框节点
			...
			var autonode1 = $("#auto1");
			// 设置提示框隐藏
			autonode1.hide().css("border", "1px black solid").css("position",
					"absolute").css("top",
					inputOffset1.top + inputItem1.height() + 5 + "px").css(
					"left", inputOffset1.left + "px").width(
					inputItem1.width() + "px");
			...
			var autonode2 = $("#auto2");
			// 设置提示框隐藏
			autonode2.hide().css("border", "1px black solid").css("position",
					"absolute").css("top",
					inputOffset2.top + inputItem2.height() + 5 + "px").css(
					"left", inputOffset2.left + "px").width(
					inputItem2.width() + "px");
